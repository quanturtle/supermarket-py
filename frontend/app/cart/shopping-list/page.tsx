                ...
                <Card>
                    <CardHeader className="border-b">
                        <CardTitle className="flex items-center justify-between">
                            ...
                            <Badge variant="outline">${supermarketData.totalPrice.toFixed(2)}</Badge>
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="pt-6">
                                    ...
                                    <div key={item.productId} className="flex items-center border-b pb-4">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="text-sm font-medium mt-1">
                                                ${item.price.toFixed(2)} × {cartItem?.quantity || 1} = ${item.total.toFixed(2)}
                                            </div>
                                        </div>
                        ...
                        <div className="mt-6 p-4 bg-gray-50 rounded-md">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-bold">${supermarketData.totalPrice.toFixed(2)}</span>
                            </div>
            ...
            <Card>
                ...
                <CardContent className="pt-6">
                    ...
                    <div className="mt-6 p-3 bg-gray-50 rounded-md text-sm">
                        <p className="font-medium">Total: ${optimal.totalPrice.toFixed(2)}</p>
                        <p className="text-gray-500 text-xs mt-1">
                            This is ${(best.totalPrice - optimal.totalPrice).toFixed(2)} less than shopping at the best single
                            supermarket.
                        </p>
                    </div>
                </CardContent>
