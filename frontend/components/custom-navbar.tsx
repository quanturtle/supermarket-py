...
export function CustomNavbar() {
    ...
    return (
        <header className="sticky top-0 z-10 bg-white border-b">
            <div className="container flex h-16 items-center justify-between px-4 md:px-6 lg:px-8 w-full max-w-screen-2xl mx-auto">
                {/* Logo on the left */}
                ...
                <div className="flex ml-auto">
                    <nav className="flex gap-4 sm:gap-6 lg:gap-8 items-center">
                        <Link
                            href="/catalog"
