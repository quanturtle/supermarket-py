import { InflationMetricCard } from "./inflation-metric-card"
import { ProductInflationChart } from "./product-inflation-chart"
...
export function InflationResultsSection({ results }: InflationResultsProps) {
  return (
    <div className="mt-8 space-y-6">
      ...
      <ProductInflationChart data={results.productInflation} />
    </div>
  )
}
